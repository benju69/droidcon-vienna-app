package at.droidcon.vienna2016.data.database;
...
public class DbMapper {
    ...
    public List<at.droidcon.vienna2016.data.app.model.Session> toAppSessions(@NonNull List<Session> from, @NonNull Map<Integer, at.droidcon.vienna2016.data.app.model.Speaker> speakersMap) {
        return stream(from).map(session -> {
            LocalDateTime fromTime = localDateTimeAdapter.fromText(session.startAt);
            return new at.droidcon.vienna2016.data.app.model.Session(session.id, Room.getFromId(session.roomId).label,
    ...
    public Session fromAppSession(@Nullable at.droidcon.vienna2016.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable at.droidcon.vienna2016.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
    ...
    public List<at.droidcon.vienna2016.data.app.model.Speaker> toAppSpeakers(@Nullable List<Speaker> from) {
        ...
        return stream(from).map(speaker -> new at.droidcon.vienna2016.data.app.model.Speaker(speaker.id,
