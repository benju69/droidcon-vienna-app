...
public class SessionsDao {
    ...
    public Observable<List<at.droidcon.vienna2016.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(at.droidcon.vienna2016.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<at.droidcon.vienna2016.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (at.droidcon.vienna2016.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(at.droidcon.vienna2016.data.app.model.Session session) {
    ...
    private Observable<List<at.droidcon.vienna2016.data.app.model.Session>> getSessions(String query, String... args) {
