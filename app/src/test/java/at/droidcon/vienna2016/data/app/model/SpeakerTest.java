...
public class SpeakerTest {
    ...
    public void should_restore_from_parcelable() {
        // Given
        Speaker speaker = new Speaker(24, "Name", "Title", "Bio", "website", "Twitter", "Github", "gPlus", "XING", "LinkedIn", "photoUrl");
        ...
        assertThat(fromParcel.getGplus()).isEqualTo("gPlus");
        assertThat(fromParcel.getXing()).isEqualTo("XING");
        assertThat(fromParcel.getLinkedin()).isEqualTo("LinkedIn");
