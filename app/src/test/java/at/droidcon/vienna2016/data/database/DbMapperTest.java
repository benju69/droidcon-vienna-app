...
public class DbMapperTest {
    ...
    public void should_convert_app_speaker_to_db_speaker() {
        ...
        // When
        at.droidcon.vienna2016.data.database.model.Speaker result = dbMapper.fromAppSpeaker(speaker);
    ...
    public void should_convert_db_speakers_to_app_speakers() {
        // Given
        at.droidcon.vienna2016.data.database.model.Speaker speaker = new at.droidcon.vienna2016.data.database.model.Speaker(58, "nilh", "dev", "bio", "nilhcem.com", "Nilhcem", "nilhcem", "https://plus.google.com/+GautierMechling", "", "https://www.linkedin.com/in/gautier-mechling-9a0a7236", "photo");
